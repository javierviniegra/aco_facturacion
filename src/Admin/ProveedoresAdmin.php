...
final class ProveedoresAdmin extends AbstractAdmin
{
    ...
    protected function configureShowFields(ShowMapper $show): void
    {
        ...
        $show
            ...
            ->tab('Contacto')
                ->with('Contactos')
                    ->add('contactos', null, ['label' => 'Listado de Contactos','template' => 'CRUD/show_field_contactos_proveedores.html.twig'])
                ->end()
            ->end()
            ->tab('Compras')
                ->with('Crédito')
                    ->add('manejoCredito',null,['label' => 'Maneja Crédito'])
                    ->add('limiteCredito', MoneyType::class, ['label' => 'Límite de Crédito','template' => 'CRUD/show_field_moneda.html.twig'])
                    ->add('diasCredito',null,['label' => 'Días de Crédito'])
                    ->add('porcentajeDescuento',PercentType::class,[
                        'label' => 'Porcentaje de Descuento',
                        'label_format' => 'penaltyRate',
                ...
                ->end()
                ->with('Bancario') 
                    ->add('banco1', null, ['label' => 'Banco 1'])
                    ->add('cuentaContable1',null,['label' => 'Cuenta Contable 1'])   
                    ->add('banco2', null, ['label' => 'Banco 2'])
                    ->add('cuentaContable2',null,['label' => 'Cuenta Contable 2'])
                ->end()
            ->end()
            ;
