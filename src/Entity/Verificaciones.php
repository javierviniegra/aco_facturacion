...
use App\Repository\VerificacionesRepository;
...
/**
 * @ORM\Entity(repositoryClass=VerificacionesRepository::class)
 * @Vich\Uploadable
...
class Verificaciones
{
     ...
     * )
     * @Vich\UploadableField(mapping="foto_verificacion_image", fileNameProperty="fotografia", size="fotografia_size")
     * @var File|null
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=InventariosInfraestructura::class, inversedBy="verificaciones")
     */
